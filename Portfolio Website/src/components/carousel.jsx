...
import GUIHammer from '../assets/GUIHammer.png';
import GUIHammer2 from '../assets/AppenderGen.png';
import GUIHammer3 from '../assets/EFTDisableTool.png';
...
function ImageCarousel () {
    ...
    // for image carousel
    const imageData = [GUIHammer, GUIHammer2, GUIHammer];

    const [count, setCount] = useState(0)
    const [currentImage, setImage] = useState(GUIHammer)
